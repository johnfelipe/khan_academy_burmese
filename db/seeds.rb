...
videos = [{:video_id => 'Video1', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra', :translator_id => nil,
          ...
          {:video_id => 'Video3', :subject => 'Math', :course => 'Calculus', :title => 'I love Calculus', :translator_id => 1,
            :typer_id => 1, :qa_id => nil, :translate_complete => 'true', :type_complete => 'false', :qa_complete => 'false', :due_date => "Jan 29 2014"},
          ...
          {:video_id => 'Video7', :subject => 'Math', :course => 'Pre-Algebra', :title => 'I love Pre-Algebra', :translator_id => 1,
            :typer_id => 1, :qa_id => 1, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'true', :due_date => "Jan 29 2014"},
          ...
          {:video_id => 'Video19', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 11', :translator_id => 1,
            :typer_id => 1, :qa_id => 1, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'true', :due_date => "Jan 29 2014"},
          {:video_id => 'Video20', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 12', :translator_id => nil,
            :typer_id => nil, :qa_id => nil, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false', :due_date => "Jan 29 2014"},
          ...
          {:video_id => 'Video22', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 14', :translator_id => 1,
            :typer_id => 1, :qa_id => nil, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false', :due_date => "Jan 29 2014"},
