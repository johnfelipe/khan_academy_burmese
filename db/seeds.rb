...
videos = [{:video_id => 'Video1', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra', :translator_id => :null, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false'},
          {:video_id => 'Video2', :subject => 'Math', :course => 'Geometry', :title => 'I love Geometry', :translator_id => 1, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'true', :type_complete => 'false', :qa_complete => 'false'},
          {:video_id => 'Video3', :subject => 'Math', :course => 'Calculus', :title => 'I love Calculus', :translator_id => 1, 
            :typer_id => 1, :qa_id => :null, :translate_complete => 'true', :type_complete => 'false', :qa_complete => 'false'},
          ...
          {:video_id => 'Video5', :subject => 'Math', :course => 'Multivariable Calculus', :title => 'I love Multivariable Calculus', :translator_id => :null, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false'},
          {:video_id => 'Video6', :subject => 'Math', :course => 'Discrete Math', :title => 'I love Discrete Math', :translator_id => :null, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false'},
          ...
          {:video_id => 'Video9', :subject => 'Math', :course => 'Pre-Calculus', :title => 'I love Pre-Calculus', :translator_id => 1, 
            :typer_id => 1, :qa_id => :null, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'false'},
          ...
          {:video_id => 'Video11', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 3', :translator_id => 1, 
            :typer_id => 1, :qa_id => 1, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'true'},
          {:video_id => 'Video12', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 4', :translator_id => :null, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false'},
          ...
          {:video_id => 'Video19', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 11', :translator_id => 1, 
            :typer_id => 1, :qa_id => 1, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'true'},
          {:video_id => 'Video20', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 12', :translator_id => :null, 
            :typer_id => :null, :qa_id => :null, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false'},
     ]
