...
videos = [{:video_id => 'Video1', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra', :translator_id => nil,
          ...
          {:video_id => 'Video24', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 14', :translator_id => 1,
            :typer_id => 1, :qa_id => nil, :translate_complete => 'true', :type_complete => 'true', :qa_complete => 'false', :due_date => "Jan 29 2014"},
          {:video_id => 'Video25', :subject => 'Math', :course => 'Algebra', :title => 'I love algebra 16', :translator_id => nil,
            :typer_id => nil, :qa_id => nil, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false', :due_date => "Jan 29 2014"},
          {:video_id => 'Video26', :subject => 'Math', :course => 'Calculus', :title => 'Calc 1B', :translator_id => nil,
            :typer_id => nil, :qa_id => nil, :translate_complete => 'false', :type_complete => 'false', :qa_complete => 'false', :due_date => "Jan 29 2014"}
